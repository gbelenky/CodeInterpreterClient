...
dotnet run --project CodeInterpreterClient/CodeInterpreterClient.csproj
```
...
# Or in Release mode
dotnet build CodeInterpreter.sln --configuration Release
dotnet CodeInterpreterClient/bin/Release/net9.0/CodeInterpreterClient.dll
```
...
### Source Files
- **`Program.cs`** - Main application code (296 lines)
